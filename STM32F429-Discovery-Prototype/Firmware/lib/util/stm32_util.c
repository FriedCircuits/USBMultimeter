...
*******************************************************************************/
char* util_floatToString(float float_number, uint8_t unit){
	uint16_t exponent;
	uint16_t fraction;
	...
	switch (unit) {
        case 0:
            string_buffer[length+4] = 'V';
            string_buffer[length+5] = '\0';
            break;

        case 1:
            string_buffer[length+4] = 'm';
            string_buffer[length+5] = 'A';
            string_buffer[length+6] = '\0';
            break;

        case 2:
            string_buffer[length+4] = 'W';
            string_buffer[length+5] = '\0';
            break;
        ...
        case 3:
            string_buffer[length+4] = 'm';
            string_buffer[length+5] = 'A';
            string_buffer[length+6] = 'h';
            string_buffer[length+7] = '\0';
            break;

        case 4:
            string_buffer[length+4] = 'm';
            string_buffer[length+5] = 'W';
            string_buffer[length+6] = 'h';
            string_buffer[length+7] = '\0';
            break;
	}
